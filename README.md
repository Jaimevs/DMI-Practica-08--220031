...
El objetivo principal de esta práctica fue incorporar una funcionalidad de búsqueda completa, permitiendo al usuario buscar cualquier película disponible en la API de TheMovieDB.

### Actividades Realizadas

- Motor de Búsqueda (Search Delegate): Se implementó Search Delegate en Flutter, siguiendo buenas prácticas de experiencia de usuario.
- Integración con API: Se configuró el servicio para realizar consultas de búsqueda en tiempo real a la API de TheMovieDB.
- Experiencia de Usuario: Se puso especial énfasis en la usabilidad del motor de búsqueda.
- Testeo: Se verificó la funcionalidad de la aplicación.
